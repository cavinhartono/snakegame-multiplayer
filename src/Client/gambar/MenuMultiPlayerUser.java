...
public class MenuMultiPlayerUser extends Menu {
	...
	public static void init(Panel root) {
		if (instance == null) {
			...
			loginAccount = new MenuString(root, "Login Account", new Font("Ink Free", Font.BOLD, 30), MenuString.Side.CENTER,
					400);
			loginAccount.setColor(Color.WHITE, Color.CYAN, Color.BLUE);
			widgets.add(loginAccount);

			createAccount = new MenuString(root, "Create Account", new Font("Ink Free", Font.BOLD, 30),
					MenuString.Side.CENTER, 450);
